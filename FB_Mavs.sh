...
dscl . append /Groups/com.apple.access_ssh user admin
dscl . append /Groups/com.apple.access_ssh groupmembers `dscl . read /Users/admin GeneratedUID | cut -d " " -f 2`
...
/System/Library/CoreServices/RemoteManagement/ARDAgent.app/Contents/Resources/kickstart -activate -configure -users admin,jss
...
if [ "$IS_LAPTOP" != "" ]; then
        pmset -b sleep 60 disksleep 10 displaysleep 5 halfdim 1
